...
contrib/$1/pkg/$1.${VERSION}.gem: contrib/$1/$1.gemspec contrib/$1/lib/**/*
	docker run --rm -t -v ${PWD}/contrib/$1/:/app -w /app ruby bash -c 'gem build -o pkg/$1.${VERSION}.gem $1.gemspec'

$1.gem: contrib/$1/pkg/$1.${VERSION}.gem

$1.push-gem: contrib/$1/pkg/$1.${VERSION}.gem
	docker run --rm -t -v ${PWD}/contrib/$1/:/app -w /app -e GEM_HOST_API_KEY=${GEM_HOST_API_KEY} ruby bash -c 'gem push pkg/$1.${VERSION}.gem'
